...
- 🌱 I started coding in 09/2019. I already have tried (or experimented with) SQL, Java, Python and C/C++, therefore I’m currently learning JavaScript (for my next Mini-Project!). The IDE´s I have worked with so far: MySQL, IntelliJ IDEA(Community), PyCharm (Community), Eclipse, VisualStudio(2019) and Visual Studio Code.
